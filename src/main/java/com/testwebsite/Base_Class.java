...
public class Base_Class {
	...
	public static void getValuesfromWebtable(String element, String value ) {
		
			WebElement table = driver.findElement(By.xpath(element));
			List<WebElement> findElements = table.findElements(By.xpath(" "));
			for (WebElement x : findElements) {
				if (x.getText().equalsIgnoreCase("value")) 
				{
					x.findElement(By.linkText(value)).click();
					break;
				}
			}
